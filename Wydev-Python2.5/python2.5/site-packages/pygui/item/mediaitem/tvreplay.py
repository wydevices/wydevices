...
class M6ReplayContainer(MediaItem, GenericContainer):
...
class TF1ReplayContainer(MediaItem, GenericContainer):
...
class W9ReplayContainer(MediaItem, GenericContainer):
...
class TVReplayContainer(MediaItem, GenericContainer):
	...
	def browse(self, preview=False):
		...
		if preview:
			return [TF1ReplayContainer(_('TF1 Replay'), menu=self.menu, parent=self),
							M6ReplayContainer(_('M6 Replay'), menu=self.menu, parent=self),
							W9ReplayContainer(_('W9 Replay'), menu=self.menu, parent=self)]
		...
		if not self._items:
			self._items = [TF1ReplayContainer(_('TF1 Replay'), menu=self.menu, parent=self),
										 M6ReplayContainer(_('M6 Replay'), menu=self.menu, parent=self),
										 W9ReplayContainer(_('W9 Replay'), menu=self.menu, parent=self)]
		return self._items
