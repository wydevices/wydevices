...
# Description:
#
# Advanced Parameters Items Class Definitions
#
#
#
# Changes:
...
from pygui.item.parameters.advanced.psfreedom import PSFreedomConfigurationItem
from pygui.item.parameters.advanced.system import SystemConfigurationItem
...
class AdvancedSetupItem(GenericContainer):
	def browse(self, preview=False):
		...
		PSFreedomConfigurationItem(name=_('USB Cable'), type_='setupitem', menu=self.menu),
		SystemConfigurationItem(name=_('System'), type_='setupitem', menu=self.menu),
