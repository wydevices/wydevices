...
wydbus_CFLAGS = @wydbus_CFLAGS@
wydbus_LIBS = @wydbus_LIBS@
wylog_CFLAGS = @wylog_CFLAGS@
wylog_LIBS = @wylog_LIBS@
wyscanextension_CFLAGS = @wyscanextension_CFLAGS@
wyscanextension_LIBS = @wyscanextension_LIBS@
pkgpython_PYTHON = __init__.py wyscan.py
bin_SCRIPTS = 
all: all-am
...
$(srcdir)/Makefile.in:  $(srcdir)/Makefile.am  $(am__configure_deps)
	...
	echo ' cd $(top_srcdir) && $(AUTOMAKE) --foreign  wyscanclt/WyScan/Makefile'; \
	cd $(top_srcdir) && \
	  $(AUTOMAKE) --foreign  wyscanclt/WyScan/Makefile
.PRECIOUS: Makefile
...
uninstall-am: uninstall-binSCRIPTS uninstall-pkgpythonPYTHON
