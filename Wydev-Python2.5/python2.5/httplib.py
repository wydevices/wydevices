...
class SSLFile(SharedSocketClient):
    ...
    def __init__(self, sock, ssl_soc, bufsize=None):
        ...
        while True:
            try:
                ...
                if (err[0] == ssl.SSL_ERROR_WANT_READ
                    or err[0] == ssl.SSL_ERROR_WANT_WRITE):
                    continue
                if (err[0] == ssl.SSL_ERROR_ZERO_RETURN
                    or err[0] == ssl.SSL_ERROR_EOF):
                    break
                raise
...
class FakeSocket(SharedSocketClient):
    ...
    def __init__(self, sock, ssl_soc):
