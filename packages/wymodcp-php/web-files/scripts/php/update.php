...
/*
 * Update process :
 * - Download and read the latest.txt file on wydevice GitHub page.
...
<?php system ("/wymedia/usr/bin/wget https://github.com/wydevices/wydevices/raw/master/packages/we-packaged/we-latest.txt > /dev/null 2>&1"); ?>
...
if ($current < $latest) {
	if (file_exists("/wymedia/tmp/wybox-extras-".$latest.".tar.gz")) {
		...
		system ("/wymedia/usr/bin/wget https://github.com/wydevices/wydevices/raw/master/packages/we-packaged/we-latest.tar.gz -q");
                system ("/wymedia/usr/bin/wget https://github.com/wydevices/wydevices/raw/master/packages/we-packaged/we-latest.md5 -q");
